    ...
    <div>
      ...
      <A href="/services#dev-and-integration">
        <svg viewBox="0 0 54 52">
          ...
          />
          <path d="M1.2 51.4h51.2a1.1 1.1 0 0 0 0-2.3h-1.1V21.3c0-.6-.5-1-1.1-1h-10v-19c0-.6-.5-1.1-1.2-1.1H14.6c-.6 0-1.1.5-1.1 1.1v19h-10c-.7 0-1.2.4-1.2 1v27.8h-1a1.1 1.1 0 0 0 0 2.3Zm47.9-29v26.7h-9V22.4h9Zm-33.4-20h22.2v46.7H15.7V2.4Zm-11.1 20h8.9v26.7h-9V22.4Z" />
        </svg>
